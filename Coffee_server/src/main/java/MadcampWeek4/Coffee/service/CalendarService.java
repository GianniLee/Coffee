...
// return
// calendarRepository.findByDrinkedCoffee_DrinkedCoffeeIndex(drinkedCoffeeIndex);
// }
...
// // Optional<Calendar> existingCalendar =
// calendarRepository.findByDrinkedCoffee_DrinkedCoffeeIndex(calendar.getDrinkedCoffee().getDrinkedCoffeeIndex());
// // if (existingCalendar.isPresent()) {
// // // 중복된 경우, 예외 처리 또는 오류 메시지 반환
// // throw new IllegalStateException("Calendar entry with this
// drinkedCoffeeIndex already exists.");
// // }
